...
<div class="screen" id="s-bolt-buff" style="overflow:hidden;">
  ...
  <div style="position:relative; z-index:2; flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:calc(var(--safe-top) + 8px) 28px 16px; gap:20px; text-align:center;">
